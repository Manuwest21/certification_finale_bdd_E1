...
chemin_bdd = os.path.join(repertoire_actuel, 'bdd_pondere10.db')
...
# Création de la table 'gare' avec nom_gare comme clé primaire
curseur.execute("""
    CREATE TABLE gare(
...
# Création de la table 'date_meteo'
curseur.execute("""
...
# Création de la table 'objets_trouves' avec une clé étrangère pour la gare et la date
curseur.execute("""
