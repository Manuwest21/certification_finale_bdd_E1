...
gares_parisiennes = [
    "Paris Gare de Lyon", "Paris Gare du Nord", "Paris Est", 
    "Paris Saint-Lazare", "Paris Austerlitz", "Paris Bercy"
]
    ...
    for annee in annees:
        ...
        if response.status_code == 200:
            ...
            for record in records['records']:
                ...
                df = df._append({'date': date, 'type': type_, 'gare': gare_}, ignore_index=True)
